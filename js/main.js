...
personalityApp.config(function($routeProvider) {
    $routeProvider
        ...
        .when('/results/:id/all', {
            templateUrl: 'templates/results-all.html',
            controller: 'resultsAllController'
        })
        .otherwise({
            redirectTo: '/'
        });
...
personalityApp.controller('resultsController', function($scope, $location, emotionsdata, $routeParams) {
    ...
    $scope.showAllResults = function(emotion) {
        $location.path('/results/' + emotion + '/all');
    };
...
personalityApp.controller('resultsAllController', function($scope, $location, emotionsdata, $routeParams) {
    //gets emotion name from URL
    $scope.emotionResult = $routeParams.id;
    $scope.emotionResults = emotionsdata.get($scope.emotionResult);
